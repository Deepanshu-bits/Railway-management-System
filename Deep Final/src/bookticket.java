...
public bookticket() {
    ...
    private void initComponents() {
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Delhi", "Kolkata", "Mumbai", "Chennai", "Bhopal", "Surat", "kozhikode","Jaipur","kochin", " " }));
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Delhi", "Kolkata", "Mumbai", "Chennai", "Bhopal", "Surat", "kozhikode","Jaipur","kochin"," "}));
        ...
        jComboBox1.setModel(new DefaultComboBoxModel(new String[] {"null", "male", "female"}));
        ...
        jButton10.setText("Display Passenger  ");
        		...
        		.addGroup(jPanel5Layout.createSequentialGroup()
        			.addGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel5Layout.createSequentialGroup()
        					...
        					.addGap(58)
        					.addComponent(jButton9, GroupLayout.PREFERRED_SIZE, 130, GroupLayout.PREFERRED_SIZE))
        				.addGroup(jPanel5Layout.createSequentialGroup()
        					.addGap(28)
        					.addComponent(jLabel11, GroupLayout.PREFERRED_SIZE, 98, GroupLayout.PREFERRED_SIZE)
        					.addGap(678))
        				.addGroup(jPanel5Layout.createSequentialGroup()
        					.addGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING)
        						.addGroup(jPanel5Layout.createSequentialGroup()
        							...
        							.addGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING)
        								...
        								.addComponent(jLabel22, GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE))
        							.addGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING)
        								.addGroup(jPanel5Layout.createSequentialGroup()
        									.addGap(47)
        									.addGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING, false)
        										...
        										.addComponent(jTextField9, GroupLayout.DEFAULT_SIZE, 55, Short.MAX_VALUE)
        										.addComponent(jLabel13)))
        								.addGroup(jPanel5Layout.createSequentialGroup()
        									.addGap(15)
        									.addGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING)
        										.addComponent(jTextField4, GroupLayout.DEFAULT_SIZE, 79, Short.MAX_VALUE)
        										.addComponent(jTextField6, GroupLayout.DEFAULT_SIZE, 79, Short.MAX_VALUE)
        										.addComponent(jTextField3, GroupLayout.DEFAULT_SIZE, 79, Short.MAX_VALUE)
        										.addComponent(jTextField7, GroupLayout.DEFAULT_SIZE, 79, Short.MAX_VALUE)
        										.addComponent(jTextField19, GroupLayout.DEFAULT_SIZE, 79, Short.MAX_VALUE))
        									.addGap(10)
        						...
        						.addGroup(jPanel5Layout.createSequentialGroup()
        							...
        							.addGroup(jPanel5Layout.createParallelGroup(Alignment.TRAILING, false)
        								...
        								.addComponent(jTextField8, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 171, Short.MAX_VALUE))
        							.addGap(186)))
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING)
        						.addGroup(jPanel5Layout.createSequentialGroup()
        							.addGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING)
        								.addGroup(jPanel5Layout.createSequentialGroup()
        									...
        									.addGroup(jPanel5Layout.createParallelGroup(Alignment.LEADING, false)
        										...
        										.addComponent(jTextField20, GroupLayout.DEFAULT_SIZE, 76, Short.MAX_VALUE)))
        	...
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup(Alignment.LEADING)
        				...
        				.addComponent(jPanel5, GroupLayout.PREFERRED_SIZE, 799, GroupLayout.PREFERRED_SIZE))
        			.addGap(85))
        );
        		...
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(layout.createSequentialGroup()
        					.addComponent(jPanel2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.UNRELATED)
        					.addComponent(jPanel3, GroupLayout.PREFERRED_SIZE, 303, GroupLayout.PREFERRED_SIZE))
        				.addGroup(layout.createSequentialGroup()
        					.addComponent(jPanel5, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        					.addGap(18)
        					.addComponent(jPanel4, GroupLayout.PREFERRED_SIZE, 123, GroupLayout.PREFERRED_SIZE)))
    ...
    try
    {
       ...
       System.out.println(fs+" "+ts);
        ...
        String SQL="Select tno,tname,dept,cost,ts,fs,doj from availabletrains where fs='"+fs+"' and ts='"+ts+"';";
        ...
        while (rs2.next())
        {
            ...
            count++;
            String ntrains=rs2.getString("tno");
        ...
        if(count==0) {
        	 ...
        	 JOptionPane.showMessageDialog(null,"Train is found");
        }
  ...
  try
{
         ...
         System.out.println(no+" "+ndoj+" "+d+" "+e);
...
{       Class.forName("com.mysql.jdbc.Driver");
        Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/irctc","root","");
   Float pnr=Float.parseFloat(jTextField3.getText());
   Float ncost=Float.parseFloat(jTextField18.getText());
   ...
   String ng3=(String)jComboBox6.getSelectedItem();
...
String strSQL = "insert into bookticket values("+pnr+",'"+ntname+"','"+fs+"','"+ts+"','"+ndept+"',"+ncost+",'"+ndoj+"','"+np1+"','"+np2+"','"+np3+"','"+ng1+"','"+ng2+"','"+ng3+"',"+nage1+","+nage2+","+nage3+","+ntcost+");";
   ...
   JOptionPane.showMessageDialog(null,"your ticket sucessfully booked PNR no. is"+pnr);
   con.close();
}
...
catch(Exception e)
{
    ...
    private void jList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList1MouseClicked
       try {
            ...
            String ntno=(String)jList1.getSelectedValue();
            ResultSet rs = con.createStatement().executeQuery("Select tname,cost,dept,doj,tno from availabletrains where tno='"+ntno+"';");

            
            while (rs.next()){
                               int ntno1=rs.getInt("tno");
                             ...
                             jTextField6.setText(""+ntname);
                            jTextField17.setText(""+ntno1);
            }
            con.close();
        } catch (Exception e) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       float p=Float.parseFloat(jTextField19.getText());
       float ncost=Float.parseFloat(jTextField18.getText());
        float ntcost=ncost*p;
        jTextField12.setText(""+ntcost);
 ...
 try {
           int npnr=Integer.parseInt(jTextField3.getText());
            ...
            JOptionPane.showMessageDialog(null,"Booking Cancel");
            con.close();
        } catch(Exception e) {
            JOptionPane.showMessageDialog(this,e.getMessage());
        }
