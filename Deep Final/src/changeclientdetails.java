...
public class changeclientdetails extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Regular Passenger  details");
        	...
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        				...
        				.addGroup(layout.createSequentialGroup()
        					...
        					.addGroup(layout.createParallelGroup(Alignment.LEADING)
        						.addGroup(layout.createParallelGroup(Alignment.LEADING, false)
        							...
        							.addComponent(jTextField6, GroupLayout.PREFERRED_SIZE, 189, GroupLayout.PREFERRED_SIZE))
        						.addComponent(jScrollPane3, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        						.addGroup(layout.createParallelGroup(Alignment.TRAILING, false)
        							.addComponent(Exit_button, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 94, Short.MAX_VALUE)
        							.addComponent(Clear_button, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 94, Short.MAX_VALUE)
        			...
        			.addGroup(layout.createParallelGroup(Alignment.LEADING)
        				...
        				.addComponent(jScrollPane4, GroupLayout.PREFERRED_SIZE, 124, GroupLayout.PREFERRED_SIZE))
        			.addGap(89))
        );
        layout.setVerticalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		...
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup(Alignment.LEADING)
        				...
        				.addGroup(layout.createSequentialGroup()
        					...
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(jScrollPane3, GroupLayout.PREFERRED_SIZE, 96, GroupLayout.PREFERRED_SIZE)
        		...
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addComponent(Display_list_button)
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        			.addComponent(jScrollPane4, GroupLayout.PREFERRED_SIZE, 222, GroupLayout.PREFERRED_SIZE)
        			.addContainerGap())
        );
    ...
    try {
        ...
        int nage=Integer.parseInt(jTextField8.getText());
            String strSQL = "update addclient set name='"+nname+"',address='"+naddress+"',dob='"+ndob+"',gender='"+ngender+"',age='"+nage+"' where clientID="+ncid+";";
