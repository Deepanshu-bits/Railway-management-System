        ...
        layout.setHorizontalGroup(
        	layout.createParallelGroup(Alignment.TRAILING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGap(79)
        			.addGroup(layout.createParallelGroup(Alignment.LEADING)
        				.addComponent(jTextField11, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
        				.addComponent(jTextField5, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
        				.addComponent(jTextField3, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
        				.addComponent(jTextField2, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
        				.addComponent(jTextField1, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
        				.addComponent(jTextField13, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
        				.addComponent(jTextField10, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
        				.addComponent(jTextField8, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
        				.addComponent(jTextField7, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
        				.addComponent(jTextField6, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
        				.addComponent(jTextField9, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
        				.addComponent(jTextField12, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
        				.addComponent(jTextField14, GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE))
        			.addGap(156))
        		.addGroup(layout.createSequentialGroup()
        			.addComponent(jLabel15, GroupLayout.DEFAULT_SIZE, 0, Short.MAX_VALUE)
        			.addGap(628))
        		.addGroup(layout.createSequentialGroup()
        			.addGap(63)
...
{    int pnr=(Integer)jList1.getSelectedValue();
     ...
     Class.forName("com.mysql.jdbc.Driver");
     Connection con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/irctc","root","");
     String strSQL = "select pnr,fs,ts,doj,p1,p2,p3,g1,g2,g3,age1,age2,age3,tcost from bookticket where pnr="+pnr+";";
     ResultSet rs2 = con.createStatement().executeQuery(strSQL);
    while (rs2.next())
...
{  String ndoj=rs2.getString("doj");
   ...
   int ntcost=rs2.getInt("tcost");

System.out.println(ng3+" bookedlist");
