...
public class Clientdetails extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        Display_list_Button.setText("Display Passenger ");
        	...
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			.addGroup(layout.createParallelGroup(Alignment.LEADING)
        						...
        						.addGroup(layout.createSequentialGroup()
        							...
        							.addGroup(layout.createParallelGroup(Alignment.LEADING)
        								.addGroup(layout.createSequentialGroup()
        									...
        									.addComponent(Clear_button, GroupLayout.PREFERRED_SIZE, 94, GroupLayout.PREFERRED_SIZE))
        								.addGroup(layout.createSequentialGroup()
        				...
        				.addGroup(layout.createSequentialGroup()
        					.addGap(120)
        					.addComponent(Exit_button, GroupLayout.PREFERRED_SIZE, 119, GroupLayout.PREFERRED_SIZE)))
        			.addContainerGap())
        );
